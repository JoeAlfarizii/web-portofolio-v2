...
export default function Home() {
    return (
        <main className="w-full">
            ...
            <article className="w-full h-[40rem] bg-gradient-to-b from-gray-700 to-gray-500">

            </article>
            <div className="fixed h-[280px] bottom-0 left-0 z-50 hidden md:block">
                <div className="flex flex-col gap-6 justify-center w-10 md:w-28 h-full items-center text-white">
                    <a
                        href="#"
                        className='hover:-translate-y-1.5 transition duration-300 ease-in-out'
                        aria-label="Github"
                        target="_blank"
                        rel="noreferrer"
                    >
